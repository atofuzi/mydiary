...
$(function () {
  //画像プレビュー処理
  var $fileInput = $(".js-file-input"); //ファイルがインプットされた場合の処理
  ...
  $fileInput.on("change", function (e) {
    ...
    $(this).parent(".js-area-drop").css("background", "#FFFFFF"); // 読み込んだ後に削除ボタンを表示する

    $(this).parent().find(".prev-close").show(); // 6. 画像読み込み
...
module.exports = __webpack_require__(/*! /Users/gotoyuya/programming/mydiary/application/resources/js/main.js */"./resources/js/main.js");
